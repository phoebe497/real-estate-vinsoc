...
def main() -> None:
    ...
    # Also scan archive directory to avoid re-logging previously submitted entries
    archive_dir = log_dir / "archive"
    if archive_dir.exists():
        for arch_file in archive_dir.glob("*.jsonl"):
            logged_ids.update(get_logged_entry_ids(arch_file))
