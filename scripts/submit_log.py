...
except ImportError:  # Direct execution: python scripts/submit_log.py
    from log_hook import sanitize_log_entry
    ...
    with open(pending, encoding="utf-8") as f:
        for line in f:
            ...
            if len(entries) >= BATCH_LIMIT:
                ...
                continue
            try:
                entries.append(sanitize_log_entry(json.loads(stripped)))
